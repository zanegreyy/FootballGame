...
function showUnluckyMessage() {
  ...
  startButton.style.display = 'block';
  startButton.textContent = 'Oops! Try again...';
...
function drawInitialScene() {
    ...
    ctx.shadowOffsetX = 5;
    ctx.shadowOffsetY = 5;
    ctx.fillText("Football Pong", canvas.width / 2, canvas.height / 3);
    ...
    ctx.shadowOffsetX = 2;
    ctx.shadowOffsetY = 2;
    ctx.fillText("First to 3 wins!", canvas.width / 2, canvas.height / 2);
